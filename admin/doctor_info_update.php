...
$id = $_GET['id'];
$result = mysqli_query($connection, "SELECT * FROM doctor_info WHERE doctor_id='$id'");
...
$result = mysqli_query($connection, "UPDATE doctor_info SET name='$update_name',degree='$update_degree',tell_number='$update_tell_number',hospital_name='$update_hospital_name',doctor_location=' $update_doctor_location',address='$update_address' WHERE doctor_id=$update_doctor_id");
    if($result){
